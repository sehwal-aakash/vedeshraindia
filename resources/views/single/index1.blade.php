...
@section('content')
    <!-- ===== HERO AREA STARTS ======= -->
    <div class="hero1-section-area" style="background-image: url(/img/vimages/background/background-image.jpg);">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="hero1-header heading1">
                        <h5 data-aos="fade-left" data-aos-duration="800"><span><img src="/img/icons/sub-logo1.svg"
                                    alt="" /></span>Create your Dream Project With Us</h5>
                        <div class="space16"></div>
                        <h1 class="text-anime-style-3">Advanced IT Solutions For Modern Businesses</h1>
                        <div class="space16"></div>
                        <p data-aos="fade-left" data-aos-duration="900">We specialize in providing innovative scalable IT
                            solutions tailored to meet the unique needs of your business, from comprehensive</p>
                        <div class="space32"></div>
                        <div class="btn-area1" data-aos="fade-left" data-aos-duration="1000">
                            <a href="{{ route('second', ['pages', 'contact']) }}" class="vl-btn1">Explore Our Solutions <i
                                    class="fa-solid fa-arrow-right"></i></a>
                            <a href="htvls://www.youtube.com/watch?v=Y8XpQpW5OVY" class="popup-youtube"><span><i
    ...
    <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -40%"
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5">
                        <div class="about-header-area heading2">
                            <h5><span><img src="/img/icons/sub-logo1.svg" alt="" /></span>About Eitech IT Solution
                            </h5>
                            <div class="space24"></div>
                            <h2 class="text-anime-style-3">Unlock Business Potential with Tailored IT Services</h2>
                            <div class="space16"></div>
                            <p data-aos="fade-left" data-aos-duration="800">At Eitech, we understand that every business
                                unique, which is why we offer customized IT solutions designed to meet.</p>
                            ...
                            <div class="pera-box" data-aos="fade-left" data-aos-duration="1000">
                                <p>“The right IT solutions done just support your on business-they transform it, at Eitech,
                                    we believe.”</p>
                            </div>
                            <div class="space28"></div>
                            <div class="btn-area1" data-aos="fade-left" data-aos-duration="1200">
                                <a href="{{ route('second', ['pages', 'contact']) }}" class="vl-btn2">See How We Can Help
        ...
        <div class="service1-section-area sp2" id="service"
            style="background-image: url(/img/all-images/bg/service-bg1.png); background-position: center; background-repeat: no-repeat; background-size: cover;">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 m-auto">
                        <div class="service-header text-center heading2 space-margin60">
                            ...
                            <div class="space24"></div>
                            <h2 class="text-anime-style-3">Expert IT Services Designed <br class="d-lg-block d-none" /> To
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-duration="800">
                        <div class="service1-boxarea">
                            ...
                            <div class="arrow">
                                <a href="{{ route('second', ['services', 'single']) }}"><i
                                        class="fa-solid fa-arrow-right"></i></a>
                            </div>
                            <div class="space24"></div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-5">
                        <div class="solution-header heading2">
                            ...
                            <div class="space32"></div>
                            <div class="btn-area1" data-aos="fade-left" data-aos-duration="1000">
                                <a href="{{ route('second', ['pages', 'contact']) }}" class="vl-btn2">Discover Our
                                    Solutions <i class="fa-solid fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
        ...
        <!-- ===== WORK AREA STARTS ======= -->
        <div class="work-others-section" id="work"
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-4">
                                        <div class="card-boxarea box1" data-aos="zoom-in" data-aos-duration="800">
                                            ...
                                            <div class="content-area">
                                                <a href="{{ route('second', ['services', 'single']) }}">Discovery
                                                    Consultation</a>
                                        ...
                                        <div class="card-boxarea box2" data-aos="zoom-in" data-aos-duration="900">
                                            <div class="content-area">
                                                <a href="{{ route('second', ['services', 'single']) }}">Customized IT
                                                    Strategy</a>
                                                <div class="space14"></div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="card-boxarea box3" data-aos="zoom-in" data-aos-duration="800">
                                            ...
                                            <div class="content-area2">
                                                <a href="{{ route('second', ['services', 'single']) }}">Quality
                                                    Assurance</a>
                                                <div class="space14"></div>
                    ...
                    <div class="case-slider-widget owl-carousel">
                        <div class="case-slider-boxarea">
                            ...
                            <div class="content-area">
                                ...
                                <div class="space16"></div>
                                <a href="{{ route('second', ['services', 'single']) }}">Upgrading IT for Financial
                                    Secure</a>
                                <div class="arrow">
                                    <a href="{{ route('second', ['services', 'single']) }}"><i
                                            class="fa-solid fa-arrow-right"></i></a>
                        ...
                        <div class="slider-galeria">
                            <div class="testimonial-slider-content-area">
                                <div class="testimonial-author-area">
                                    ...
                                    <p>Partnering with ETech has transformed our IT Solution Their tailored solutions help
                                        streamline our operations, improve cybersecurity, and drive efficiency across the
                                        board. We've experienced fewer disruptions, faster an.”</p>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-4 m-auto">
                        <div class="vl-blog-1-section-box heading2 text-center space-margin60">
                            <h5 class="vl-section-subtitle"><span><img src="/img/icons/sub-logo1.svg"
                                        alt="" /></span>our blog</h5>
                            <div class="space20"></div>
                            <h2 class="vl-section-title text-anime-style-3">Stay Updated with the Latest in IT Solutions
                            </h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="vl-blog-1-item">
                            ...
                            <div class="vl-blog-1-content">
                                <div class="vl-blog-meta">
                                    <ul>
                                        <li>
                                            <a href="#"><img src="/img/icons/calender1.svg" alt="" /> 26
                                                August 2024 <span>|</span></a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="/img/icons/user1.svg" alt="" /> Alex
                                                Roy</a>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <h4 class="vl-blog-1-title"><a
                                        href="{{ route('third', ['blog', 'details', 'single']) }}">Revolutionize Your
                                        Business Operations with Advanced IT Solution Technology</a></h4>
                                <div class="space16"></div>
                                <p>Fuel your business success with our custom IT services. We design solutions that are
                                    tailored to your an specific needs.</p>
                                <div class="vl-blog-1-icon">
                                    <a href="{{ route('third', ['blog', 'details', 'single']) }}"><i
                                            class="fa-solid fa-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6" data-aos="fade-right" data-aos-duration="1000">
                        <div class="vl-blog-1-item">
                            ...
                            <div class="vl-blog-1-content">
                                ...
                                <div class="space20"></div>
                                <h4 class="vl-blog-1-title"><a
                                        href="{{ route('third', ['blog', 'details', 'single']) }}">Transform Your Business
                                        Operations with Tailored IT Solutions Designed</a></h4>
                                <div class="space16"></div>
                                <p>Fuel your business success with our custom IT services. We design solutions that are
                                    tailored to your an specific needs.</p>
                                <div class="vl-blog-1-icon">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="btn-area1 text-center">
                            <a href="{{ route('second', ['blog', 'blog1']) }}" class="vl-btn2">Read More Blog And News <i
                                    class="fa-solid fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
